...
def create_service(service):
    ...
    for device in device_list:
        ...
        # It will be stored even if the service is not executed, so it's make possible to use the same configuration in the future.
        ...
        try:
            ...
            initial_config_json = " "
            service_status = "Execution Failed"
            date = datetime.datetime.now()
    ...
    return [service_id,service_applied,service_name,applied_config_json,initial_config_json,service_status,date]
